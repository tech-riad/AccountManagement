        ...
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-gradient-warning btn-rounded btn-fw" data-bs-toggle="modal"
                    data-bs-target="#addModal">Add Transaction</button>
                                ...
                                <td>
                                    <div class="actions ml-3">
                                        <a href="#" class="action-item customModal" data-toggle="modal"
                                            data-target="#editModal" data-accounts="{{ $item }}"
                                            data-original-title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="#" class="action-item deleteAccount"
                                            data-account-id="{{ $item->id }}" data-original-title="Delete">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="payment_date" required="required" type="date"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="account_method" id="editBankaAccountMethod" class="form-select"
                                        required>
                                        @foreach($bank as $item)
                                            <option value="{{ $item->id }}">{{ $item->method_name }}</option>
                                        @endforeach
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="payment_date" type="date" value=""
                                        id="editPaymentDate">
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6 d-none">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="created_by" id="editCreatedBy" class="form-control"
                                        value="{{ Auth::user()->name }}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
