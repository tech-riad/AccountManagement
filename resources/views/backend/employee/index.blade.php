                                ...
                                <td>
                                    <div class="actions ml-3">
                                        <a href="#" class="action-item customModal" data-toggle="modal"
                                            data-target="#editModal" data-employee="{{ $item }}"
                                            data-original-title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="#" class="action-item deleteEmployee"
                                            data-employee-id="{{ $item->id }}" data-original-title="Delete">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editEmployeeForm">
                    ...
                    <button type="button" id="updateEmployeeBtn" class="btn btn-primary" data-bs-dismiss="modal">Update
                        Employee</button>
                </form>
            </div>
        </div>
